...
import jp.osaka.appppy.people.databinding.ActivityDetailBinding;
...
public class DetailActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        // メニュー設定
        if(mDataSet.isTrash) {
            getMenuInflater().inflate(R.menu.trash_simple_detail, menu);
        } else if(mDataSet.isArchive) {
            getMenuInflater().inflate(R.menu.archive_simple_detail, menu);
        } else {
