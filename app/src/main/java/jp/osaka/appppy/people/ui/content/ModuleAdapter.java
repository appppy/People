 ...
 * モジュールアダプタ
 */
class ModuleAdapter extends RecyclerArrayAdapter<SimplePerson, ModuleAdapter.BindingHolder> {
     ...
     * @param collection 一覧
     */
    ModuleAdapter(Context context, ItemListener<SimplePerson> listener, List<SimplePerson> collection) {
        super(collection);
        mContext = context;
