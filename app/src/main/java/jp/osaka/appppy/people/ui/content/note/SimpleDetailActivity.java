...
import jp.osaka.appppy.people.databinding.ActivityNoteDetailLightBinding;
...
public class SimpleDetailActivity extends AppCompatActivity {
     ...
     * @serial バインディング
     */
    private ActivityNoteDetailLightBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String TAG = "SimpleDetailActivity";
        if (LOG_I) {
        ...
        // レイアウトの設定
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_note_detail_light);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        // メニュー設定
        getMenuInflater().inflate(R.menu.main_simple_detail, menu);
