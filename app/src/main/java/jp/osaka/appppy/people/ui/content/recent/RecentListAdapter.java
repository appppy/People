 ...
 * 一覧アダプタ
 */
class RecentListAdapter extends RecyclerArrayAdapter<SimplePerson, RecentListAdapter.BindingHolder> {
     ...
     * @param collection 一覧
     */
    RecentListAdapter(Context context, ItemListener<SimplePerson> listener, List<SimplePerson> collection) {
        super(collection);
        mContext = context;
