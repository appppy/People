 ...
 * モジュールフラグメント
 */
public class RecentModuleFragment extends Fragment implements
     ...
     * @serial タグ
     */
    private final String TAG = "RecentModuleFragment";
     ...
     * @serial 自身
     */
    private final RecentModuleFragment mSelf;

    /**
     * @serial アダプタ
     */
    private RecentModuleAdapter mAdapter;
     ...
     */
    public static RecentModuleFragment newInstance(ArrayList<SimplePerson> collection) {
        // フラグメントの生成
        RecentModuleFragment fragment = new RecentModuleFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // アダプタの設定
        mAdapter = new RecentModuleAdapter(getContext(), this, people);
                ...
                try {
                    switch (actionState) {
                        ...
                        default: {
                            ...
                            RecentModuleAdapter.BindingHolder holder = (RecentModuleAdapter.BindingHolder) viewHolder;
                            // 項目の選択状態の取得
