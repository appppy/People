...
import jp.osaka.appppy.people.databinding.ActivityFileDetailBinding;
...
public class DetailActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // レイアウトの設定
        ActivityFileDetailBinding mBinding = DataBindingUtil.setContentView(this, R.layout.activity_file_detail);
